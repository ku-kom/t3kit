...
// $contentElementIconFilePath = 'EXT:theme_ku/Resources/Public/Icons/ContentElements/';
// $contentElementIcons = [
//     'ce-custom'
// ];
...
\T3k\ku\Hooks\PageLayoutView\ExampleContentElementCEPreviewRenderer::class;


// Register RTE presets
if (empty($GLOBALS['TYPO3_CONF_VARS']['RTE']['Presets']['ku_default'])) {
    $GLOBALS['TYPO3_CONF_VARS']['RTE']['Presets']['ku_default'] = 'EXT:theme_ku/Configuration/RTE/Default.yaml';
}
